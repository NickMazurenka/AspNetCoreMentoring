...
namespace IO.Swagger.Test
{
    ...
    public class CategoriesApiTests
    {
        ...
        public void GetTest()
        {
            ...
            //Assert.IsInstanceOf<List<CategoryGetDto>> (response, "response is List<CategoryGetDto>");
        }
        ...
        public void Get_0Test()
        {
            ...
            //Assert.IsInstanceOf<CategoryGetDto> (response, "response is CategoryGetDto");
        }
